...
if ($clip): ?>
    ...
    <script src="jquery-ui-1.8.2.custom/js/jquery-1.4.2.min.js" type="text/javascript"></script>
    <script src="jquery-ui-1.8.2.custom/js/jquery-ui-1.8.2.custom.min.js" type="text/javascript"></script>
    ...
    jQuery(document).ready(function() {
        ...
        function seekTo(time, absolute, upJWPlayer, upTimeline) {
            ...
            currentTime = Math.max(currentTime, <?php echo $clip->playabletimestart; ?>);
            currentTime = Math.min(currentTime, <?php echo $clip->playabletimeend; ?>);
        ...
        var params = {
            "id": <?php echo $clip->id; ?>,
            "clipId": <?php echo $clip->id; ?>,
            "userId": <?php echo $userid ? $userid : "undefined"; ?>,
            "groupId": <?php echo $groupid ? $groupid : "undefined"; ?>,
            "selector": "#TimelineFrame_Timeline1",
            "dialogBoxSelector": "#dialogbox",
            "minTime": <?php echo $clip->playabletimestart; ?>,
            "maxTime": <?php echo $clip->playabletimeend; ?>,
            "currentScaleIndex": 1,
            ...
            "streamUpdate": <?php echo $videoannotation->groupmode == VIDEOANNOTATION_GROUPMODE_GROUP_GROUP ? 10000 : 0; ?>,
            "readOnlyGroup": <?php echo $videoannotation->groupmode == VIDEOANNOTATION_GROUPMODE_GROUP_USER ? 'true' : 'false'; ?>
        }
        ...
        jQuery("#flashPlayerScrubBar").slider({
            range: "min",
            min: <?php echo $clip->playabletimestart; ?> * 1000,
            max: <?php echo $clip->playabletimeend; ?> * 1000,
            start: function() {
        ...
        $('#rewindbutton').click(function(event) {
            if (jwplayer().getState() == "PAUSED" || jwplayer().getState() == "IDLE")
                pausePosition = <?php echo $clip->playabletimestart; ?>;
            seekTo(<?php echo $clip->playabletimestart; ?>, true, true, true);
        ...
        jQuery('#instructioncontent').dialog({
            ...
            jwplayer().resize(<?php echo $clip->videowidth; ?>, jwplayer().getHeight());
        });
        ...
        jwplayerParams["file"] = "<?php echo $matches[1];?>mp4:<?php echo $matches[2];?>";
        <?php else: ?>
        jwplayerParams["file"] = "<?php echo $clip->url; ?>";
        <?php endif; ?>
